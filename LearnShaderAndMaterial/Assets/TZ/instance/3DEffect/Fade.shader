...
Shader "Unlit/Fade"//透视效果
{
	...
	Properties
	{
		...
		_DistanceNear("最小距离",float) = 10
		_DistanceFar("最大距离",float) = 20
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			v2f vert (appdata v)
			{
				...
				//saturate把值限制在0-1之间，小于0返回0，大于1返回1
				o.fade = 1-saturate((dis - _DistanceNear)/(_DistanceFar-_DistanceNear));
